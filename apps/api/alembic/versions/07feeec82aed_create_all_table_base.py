...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("ACTIVE", "INACTIVE", "SUSPENDED", name="userstatus"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_tenant_email_configs_tenant_id"),
        "tenant_email_configs",
        ["tenant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("TWILIO", "ANDROID_GATEWAY", "CONSOLE", name="smsprovidertype"),
            nullable=False,
        ),
        sa.Column("encrypted_credentials", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_tenant_sms_configs_tenant_id"), "tenant_sms_configs", ["tenant_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_tenant_social_providers_tenant_id"),
        "tenant_social_providers",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_tenant_auth_configs_tenant_id"), "tenant_auth_configs", ["tenant_id"], unique=True
    )
    op.create_table(
        "user_roles",
        sa.Column("user_id", sa.UUID(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_tenant_social_providers_tenant_id"), table_name="tenant_social_providers"
    )
